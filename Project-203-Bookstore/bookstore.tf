...
provider "github" {
  token = "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"
}
...
resource "aws_instance" "tf-docker-ec2" {
  ...
  user_data = <<-EOF
          ...
          TOKEN="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"
          FOLDER="https://$TOKEN@raw.githubusercontent.com/mattsystm/bookstore-repo/main/"
          ...
          docker build -t mattsystm/bookstoreapi:latest .
          docker-compose up -d
          EOF
