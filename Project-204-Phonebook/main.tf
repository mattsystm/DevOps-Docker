...
locals {
  github-repo = "https://github.com/mattsystm/DevOps-Docker/tree/main/Project-204-Phonebook.git"
  github-file-url = "https://raw.githubusercontent.com/mattsystm/DevOps-Docker/master/"
}
